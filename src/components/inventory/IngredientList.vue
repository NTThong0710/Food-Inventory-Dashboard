  ...
  <transition name="fade">
    ...
    <div class="flex flex-col">
      <div v-for="item in paginatedInventory" :key="item.sku" 
           class="grid grid-cols-1 md:grid-cols-[2fr_0.5fr_1.5fr_1.5fr_2fr_1fr_1fr_40px] gap-4 px-6 py-5 border-b border-[#2A362C] hover:bg-[#1A231C]/60 transition-colors items-center group relative cursor-default">
...
import type { Ingredient } from '@/stores/inventory';
